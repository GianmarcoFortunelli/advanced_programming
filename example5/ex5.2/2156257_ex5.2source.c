...
void insertEl(struct node **pHead) {
    int i,el, ind; //help variable
    printf("Choice if insert in head(1), in tail(2), by index(3):\n");
    scanf("%d",&i);
    printf("insert the element to insert\n");
    scanf("%d",&el);
    switch (i) {
        case 1: indexInsert(pHead,0,el); break;
        case 2: tailInsert(pHead, el); break;
        case 3:
            printf("insert index for insertion:\n");
            scanf("%d",&ind);
            indexInsert(pHead,ind,el);    //must count the head node
            break;
        default:
            printf("wrong choice\n"); break;
...
void printMenu() {
    ...
    printf("2.Print the elements from the head;\n");
    printf("3.Print the elements from the tail;\n");
    printf("4.Print the length of the list;\n");
    printf("5.Identify whether the list is empty;\n");
    printf("6.Clear the list and obtain an empty list;\n");
    printf("7.Insert an element in the list;\n");
    printf("8.Delete the element on the given position;\n");
    printf("9.Destroy the double linked list.\n");
