...
keyType1 predecessor(bst* t, keyType1 e){
...
keyType1 successor(bst* t, keyType1 e){
    bstNode * n= searchBst(t, e);
    if(n==NULL){
        printf("Error: cannot find element\n");
        return 0;
...
void insertBst(bst* t, keyType1 e, char * name){
...
void deleteBst(bst* t, keyType1 e){
    bstNode* n= searchBst(t, e);
    if(t->root==NULL) return;
